...
| CON-3 | MVP 월 인프라 비용 200만 원 이하 (에셋 라이트 원칙) | 비용 | PRD 5-3 |
...
| ID | 문서명 | 출처 / 경로 |
|---|---|---|
| REF-01 | PRD v0.1 건기식 성분·가격 비교 초자동화 플랫폼 | `../PRD_v0.1.md` |
| REF-02 | VPS Merged V2 (fin) | `../04_VPS-final/06_value-proposition-sheet_260410(fin).md` |
| REF-03 | Porter's 5 Forces 시장 환경 분석 | `01_Biz-Analysis/1_porters-foreces.md` |
| REF-04 | 3개 도메인 경쟁사 분석 | `01_Biz-Analysis/2_competents-analysis.md` |
| REF-05 | Value Chain + KSF | `01_Biz-Analysis/3_value-chain.md`, `4_ksf-report.md` |
| REF-06 | TAM-SAM-SOM + 시장 세분화 | `01_Biz-Analysis/6_TAM-SAM-SOM+MarketSegment.md` |
| REF-07 | Persona Spectrum Map | `01_Biz-Analysis/7_persona-spectrum-map.md` |
| REF-08 | Customer Journey Map | `01_Biz-Analysis/8_customer-journey-map.md` |
| REF-09 | AOS-DOS Combined Analysis | `01_Biz-Analysis/9_aos-dos-analysis.md` |
| REF-10 | JTBD Interview Report | `01_Biz-Analysis/10_jtbd-interview-report.md` |
| REF-11 | 한국소비자원 시장 조사 (2022) | 외부 공개 보고서 |
| REF-12 | 식약처 소비자 인식조사 (2021) | 외부 공개 보고서 |
| REF-13 | 공정거래위원회 온라인 광고 실태조사 (2023) | 외부 공개 보고서 |
| REF-14 | 한국건강기능식품협회 보고서 (2023) | 외부 공개 보고서 |
| REF-15 | Nielsen Korea (2022) | 외부 공개 보고서 |
| REF-16 | ISO/IEC/IEEE 29148:2018 | 국제 표준 |
...
| EXT-SYS-05 | 카카오 Link API | 외부 JS SDK | 카카오톡 공유 카드 생성·전송 | 일 발송 제한 확인 필요 |
...
| ID | 요구사항 | 측정 지표 | 기준 | Source |
|---|---|---|---|---|
| **REQ-NF-019** | MVP 월간 인프라 비용은 200만 원 이하이다. | 월간 비용 | <= 200만 원 | PRD 5-3, CON-3 |
| **REQ-NF-020** | 인프라 비용 초과 시 Slack `#infra-cost` 채널에 자동 알림을 발송하고, 매월 1일 AWS Cost Explorer 월간 리포트를 경영진에게 공유한다. | 알림/리포트 | 초과 시 즉시 알림 + 월 1회 리포트 | PRD 5-3 |
